...
function invocarControlador(dataParametros, funcionOK) {
    controladorAJAX_GET('handlers/CentrosHandler.ashx', dataParametros, funcionOK);
}

function invocarControlador_POST(dataParametros, funcionOK) {
    controladorAJAX_POST('handlers/CentrosHandler.ashx', dataParametros, funcionOK);
}
