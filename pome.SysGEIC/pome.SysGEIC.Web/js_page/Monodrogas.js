...
function configurarGrilla() {
    $('#dg').datagrid({
        title: 'Información de Monodrogas',
        width: 1198,
        height: 300,
        autoRowHeight: false,
        collapsible: false,
...
function invocarControlador(dataParametros, funcionOK) {
    controladorAJAX_GET('handlers/MonodrogasHandler.ashx', dataParametros, funcionOK);
}

function invocarControlador_POST(dataParametros, funcionOK) {
    controladorAJAX_POST('handlers/MonodrogasHandler.ashx', dataParametros, funcionOK);
}
