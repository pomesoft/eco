...
{
    /// <summary>
    /// Summary description for EstadosDocumentosHandler
    /// </summary>
    public class EstadosDocumentoHandler : IHttpHandler
    {
        ...
        private object Grabar(string id, string descripcion)
        {
            ...
            try
            {
                ...
                servicio.EstadoDocumentoGrabar(id, descripcion);
        ...
        private object Eliminar(string id)
        {
            ...
            try
            {
                ...
                servicio.EstadoDocumentoEliminar(id);
