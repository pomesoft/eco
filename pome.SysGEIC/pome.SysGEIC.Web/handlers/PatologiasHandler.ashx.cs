...
{
    /// <summary>
    /// Summary description for PatologiasHandler
    /// </summary>
    public class PatologiasHandler : IHttpHandler
    {
        ...
        private string Listar(string descripcion)
        {
            ...
            return serializer.Serialize(servicio.PatologiaObtenerVigentes(descripcion));
        }
        ...
        private string Obtener(string id)
        {
            ...
            if (int.TryParse(id, out _id))
                return serializer.Serialize(servicio.PatologiaObtener(_id));
            else
                return string.Empty;
        }
        private object Grabar(string id, string descripcion)
        {
            ...
            {
                ServicioParametricas servicio = new ServicioParametricas();
                servicio.PatologiaGrabar(id, descripcion);
