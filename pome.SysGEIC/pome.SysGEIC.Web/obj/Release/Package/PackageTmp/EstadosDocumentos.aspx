<%@ Page Title="" Language="C#" MasterPageFile="~/Sitio.Master" AutoEventWireup="true" CodeBehind="EstadosDocumentos.aspx.cs" Inherits="pome.SysGEIC.Web.EstadosDocumentos" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHead" runat="server">
    <script src="js_page/EstadosDocumento.js" type="text/javascript"></script>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceBody" runat="server">
    <div id="dg_toolbar" style="padding: 5px; height: auto">
        <div>
            ...
            <a href="#" id="btnBuscar" name="btnBuscar" class="easyui-linkbutton" iconcls="icon-search" plain="true">Buscar</a>
        </div>
    </div>
    ...
    <div id="toolbar" style="padding: 3px; width: 100%; border: 1px solid #ccc; margin-bottom: 10px;">
        ...
        <div class="fitem">
            <label class="labelAncho" for="Descripcion">
                Descripción:</label>
            <input class="easyui-validatebox campoABM" type="text" id="txtDescripcion" name="Descripcion" data-options="required:true"></input>
        </div>       
</asp:Content>
