...
function configurarGrilla() {
    $('#dg').datagrid({
        title: 'Información Estados de Documentos',
        width: '100%',
        height: 400,
        autoRowHeight: false,
        collapsible: false,
        ...
        sortOrder: 'asc',
        columns: [[
		    { field: 'Id', title: 'Código', sortable: true, width: '10%' },
		    { field: 'Descripcion', title: 'Descripción', sortable: true, width: '90%' }
	  ]],
...
function invocarControlador(dataParametros, funcionOK) {
    controladorAJAX_GET('handlers/EstadosDocumentoHandler.ashx', dataParametros, funcionOK);
}

function invocarControlador_POST(dataParametros, funcionOK) {
    controladorAJAX_POST('handlers/EstadosDocumentoHandler.ashx', dataParametros, funcionOK);
}
