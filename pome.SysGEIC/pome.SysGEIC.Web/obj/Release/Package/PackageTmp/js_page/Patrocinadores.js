...
function configurarGrilla() {
    $('#dg').datagrid({
        title: 'Información de Patrocinadores',
        width: 1198,
        height: 300,
        autoRowHeight: false,
        collapsible: false,
        ...
        columns: [[
		    ...
		    { field: 'Descripcion', title: 'Razón Social', width: 670 }
	  ]],
...
function invocarControlador(dataParametros, funcionOK) {
    controladorAJAX_GET('handlers/PatrocinadoresHandler.ashx', dataParametros, funcionOK);
}

function invocarControlador_POST(dataParametros, funcionOK) {
    controladorAJAX_POST('handlers/PatrocinadoresHandler.ashx', dataParametros, funcionOK);
}
