...
function configurarGrilla() {
    $('#dg').datagrid({
        title: 'Información Estados de Recordatorios',
        width: 1198,
        height: 300,
        autoRowHeight: false,
        collapsible: false,
...
function invocarControlador(dataParametros, funcionOK) {
    controladorAJAX_GET('handlers/EstadosRecordatorioHandler.ashx', dataParametros, funcionOK);
}

function invocarControlador_POST(dataParametros, funcionOK) {
    controladorAJAX_POST('handlers/EstadosRecordatorioHandler.ashx', dataParametros, funcionOK);
}
