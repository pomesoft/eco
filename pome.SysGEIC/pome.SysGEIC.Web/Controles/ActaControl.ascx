...
<%@ Register Src="PlantillaSeleccionControl.ascx" TagName="PlantillaSeleccionControl"
    TagPrefix="uc1" %>
...
<div id="toolbar" style="padding: 3px; width: 1190px; border: 1px solid #ccc">
    ...
    <a href="#" id="btnActaCartaRespuesta" class="easyui-linkbutton" iconcls="icon-view"
        plain="true" onclick="actaSeleccionarEstudioCartaRespuesta()">Carta de Respuesta</a>
...
<div class="easyui-texteditor" id="txtActaComentarioInicialFijo" data-options="title:'Comentario'" style="width:'100%';height:200px;padding:20px"></div>
<div id="panelComentarioInicialFijo">
    
</div>
<div id="panelComentarioInicial">
    <div class="easyui-texteditor" id="txtActaComentarioInicial" data-options="title:'Comentario'" style="width:'100%';height:200px;padding:20px"></div>
</div>
<div id="panelComentarioFinal">
    <div class="easyui-texteditor" id="txtActaComentarioFinal" data-options="title:'Comentario'" style="width:'100%';height:200px;padding:20px"></div>
</div>
